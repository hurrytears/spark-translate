...
private[spark] object RDDOperationScope extends Logging {
    ...
    /**
      * Execute the given body such that all RDDs created in this body will have the same scope.
      *
      * If nesting(嵌套) is allowed, any subsequent calls to this method in the given body will
      * instantiate(实例化)child scopes that are nested within our scope. Otherwise, these calls
      * will take no effect.
      * 嵌套后，子方法也会拥有scope
      *
