...
private[deploy] class Worker(
    ...
    /**
      ...
      * 是否使用masterRPCAddress中的master的地址，如果不可用，worker会使用从master接收的地址
      */
    ...
    /**
      ...
      * 为防止连接到master地址错误，当连接断开的时候，worker会使用这个地址去连接
      */
